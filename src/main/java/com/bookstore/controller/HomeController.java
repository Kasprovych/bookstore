...
import com.bookstore.utitlity.MailConstructor;
import com.bookstore.utitlity.SecurityUtility;
import com.bookstore.utitlity.USConstants;
...
public class HomeController {
	...
	public String updateUserInfo(@ModelAttribute("user") User user,
		...
		if (userService.findByEmail(user.getEmail()) != null) {
			if (userService.findByEmail(user.getEmail()).getId() != currentUser
					.getId()) {
				model.addAttribute("emailExists", true);
				return "myProfile";
			}
		...
		if (newPassword != null && !newPassword.isEmpty()
				&& !newPassword.equals("")) {
			BCryptPasswordEncoder passwordEncoder = SecurityUtility
					.passwordEncoder();
